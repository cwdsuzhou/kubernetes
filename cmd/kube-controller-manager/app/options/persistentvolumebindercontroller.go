...
func (o *PersistentVolumeBinderControllerOptions) AddFlags(fs *pflag.FlagSet) {
	...
	fs.DurationVar(&o.VolumeOperationMaxBackoff.Duration, "pv-max-backoff-time", o.VolumeOperationMaxBackoff.Duration, "The maximum backoff time of pv operation, defaults to 2minutes+2second.")
}
