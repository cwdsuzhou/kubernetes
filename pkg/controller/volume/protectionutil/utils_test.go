...
func TestIsDeletionCandidateNoDeleteTime(t *testing.T) {

	tests := []TestCase{
		{
			name:      "pv does not have delete time",
			obj:       pv(),
			finalizer: util.PVProtectionFinalizer,
			result:    false,
		},
		{
			name:      "pvc does not have finalizes",
			obj:       pvc(),
...
func TestIsDeletionCandidateNoFinalizer(t *testing.T) {
	...
	tests := []TestCase{
		{
			name:      "pv does not have no finalizer",
			obj:       pv,
			finalizer: util.PVProtectionFinalizer,
			result:    false,
		},
		{
			name:      "pvc does not have no finalizer",
			obj:       pvc,
			finalizer: util.PVCProtectionFinalizer,
			result:    false,
		},
